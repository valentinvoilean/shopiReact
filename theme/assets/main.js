...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxImmutableStateInvariant = __webpack_require__(219);
	...
	function configureStore(initialState) {
	    ...
	    return (0, _redux.createStore)(_rootReducer2.default, initialState, (0, _redux.compose)(_redux.applyMiddleware.apply(undefined, middlewares), window.devToolsExtension ? window.devToolsExtension() : function (f) {
	        return f;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonStringifySafe = __webpack_require__(220);
	
	var _jsonStringifySafe2 = _interopRequireDefault(_jsonStringifySafe);
	
	var _isImmutable = __webpack_require__(221);
	
	var _isImmutable2 = _interopRequireDefault(_isImmutable);
	
	var _trackForMutations = __webpack_require__(222);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeaderConfig = __webpack_require__(225);
	
	var _HeaderConfig2 = _interopRequireDefault(_HeaderConfig);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = (0, _redux.combineReducers)({ headerConfig: _HeaderConfig2.default });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headerSettings = __webpack_require__(229);
	
	var SAVE_HEADER_SETTINGS = 'SAVE_HEADER_SETTINGS';
	var REMOVE_HEADER_ITEM = 'REMOVE_HEADER_ITEM';
	
	// Reducer
	
	exports.default = function () {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _header.getInitialState)();
	    ...
	    switch (action.type) {
	        case SAVE_HEADER_SETTINGS:
	            {
	                var to = action.to,
	                    ...
	                    shouldComponentUpdate = action.shouldComponentUpdate,
	                    mediaQuery = action.mediaQuery;
	
	
	                return state.set('shouldComponentUpdate', shouldComponentUpdate).setIn(['data', mediaQuery, to], (0, _immutable.List)(children));
	            }
	        ...
	        case REMOVE_HEADER_ITEM:
	            {
	                var _ret = function () {
	                    ...
	                    return {
	                        v: state.updateIn(['data', mediaQuery, 'Hidden'], function (arr) {
	                            return arr.push(item);
	                        }).updateIn(['data', mediaQuery, from], function (arr) {
	        ...
	        default:
	            {
	                try {
	                    (0, _header.validateState)(state);
	                    return _headerSettings.defaultState.get('HeaderConfig').mergeDeep(state);
	                } catch (e) {
	                    console.warn(e);
	                    return _headerSettings.defaultState.get('HeaderConfig');
	                }
	            }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.validateState = exports.getInitialState = undefined;
	
	var _getInitialState2 = __webpack_require__(228);
	
	var _getInitialState3 = _interopRequireDefault(_getInitialState2);
	
	var _validateState2 = __webpack_require__(230);
	
	var _validateState3 = _interopRequireDefault(_validateState2);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.getInitialState = _getInitialState3.default;
	exports.validateState = _validateState3.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getInitialState() {
	    ...
	    try {
	        currentSettings = (0, _immutable.fromJS)({
	            data: JSON.parse(_headerSettings.headerSettings),
	            shouldComponentUpdate: false
	        });
	    } catch (err) {
	        console.warn('Data not valid ! The default settings will be used instead ');
	        currentSettings = _headerSettings.defaultState.get('HeaderConfig');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var validStates = exports.validStates = (0, _immutable.Map)({
	    mobile: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cells = void 0,
	    validAreas = void 0,
	    _validateCellNames = function _validateCellNames() {
	    var validCellNames = Object.keys(validAreas);
	    var availableCellNames = Object.keys(cells);
	
	    for (var i = 0, len = availableCellNames.length; i < len; i++) {
	        if (validCellNames.indexOf(availableCellNames[i]) === -1) {
	            throw 'The cell ' + availableCellNames[i] + ' doesn\'t exist.';
	        }
	    }
	},
	    _validateItemNames = function _validateItemNames(cell, cellName, validItemNames) {
	    for (var i = 0, len = cell.length; i < len; i++) {
	        if (!(0, _lodash.includes)(validItemNames, cell[i])) {
	            var single = validItemNames.length === 1;
	            throw 'Only ' + (single ? 'the' : '') + ' ' + validItemNames.join(', ') + ' ' + (single ? 'is' : 'are') + ' allowed in ' + cellName + '.';
	        }
	    }
	},
	    _validateItemRequirements = function _validateItemRequirements(cell, validItems) {
	    var _loop = function _loop(i, len) {
	        var item = cell[i];
	        var currentValidItem = validItems.filter(function (obj) {
	            return obj.name === item;
	        })[0];
	
	        if (typeof currentValidItem.required !== 'undefined') {
	            (function () {
	                var requiredName = currentValidItem.required.name;
	                var requiredPositions = currentValidItem.required.position;
	                var throwErrorMessage = function throwErrorMessage() {
	                    throw 'The item ' + requiredName + ' is required inside the ' + (requiredPositions instanceof Array ? requiredPositions.join(' or ') : requiredPositions) + ' cell.';
	                };
	
	                if (requiredPositions instanceof Array) {
	                    var included = false;
	
	                    for (var j = 0, rpLen = requiredPositions.length; j < rpLen; j++) {
	                        if ((0, _lodash.includes)(cells[requiredPositions[j]], requiredName)) {
	                            included = true;
	                            break;
	                        }
	                    }
	                ...
	                } else if (!(0, _lodash.includes)(cells[requiredPositions], requiredName)) {
	                    throwErrorMessage();
	                }
	            })();
	        }
	    ...
	    _validateComplexItems = function _validateComplexItems(cell, cellName, validItems) {
	    var validItemNames = validItems.map(function (item) {
	        return item.name;
	    });
	    ...
	    _validateCellConditions = function _validateCellConditions(cell, cellName, cellConditions) {
	    ...
	    _parseEachHeaderArea = function _parseEachHeaderArea(mediaQuery) {
	    ...
	    for (var cellName in cells) {
	        ...
	        var complexCell = !(validAreas[cellName] instanceof Array);
	        var validItems = complexCell ? validAreas[cellName].items : validAreas[cellName];
	        var complexItems = typeof validItems[0] !== 'string';
	...
	function validateState(state) {
	    ...
	    _headerSettings.validStates.keySeq().forEach(function (mediaQuery) {
	        ...
	        validAreas = _headerSettings.validStates.get(mediaQuery);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var v4 = __webpack_require__(239);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rng = __webpack_require__(237);
	var bytesToUuid = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containers = __webpack_require__(768);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Header2 = __webpack_require__(280);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactMatchMedia = __webpack_require__(281);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Wishlist = __webpack_require__(440);
	...
	var _MyAccount = __webpack_require__(442);
	...
	var _WelcomeMessage = __webpack_require__(451);
	...
	var _Breadcrumb = __webpack_require__(455);
	...
	var _Language = __webpack_require__(459);
	...
	var _SocialIcons = __webpack_require__(461);
	...
	var _CustomLink = __webpack_require__(463);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Wishlist2 = __webpack_require__(441);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MyAccount2 = __webpack_require__(443);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Logo2 = __webpack_require__(445);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Menu2 = __webpack_require__(447);
	
	var _Menu3 = _interopRequireDefault(_Menu2);
	
	var _MenuIcon2 = __webpack_require__(448);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cart2 = __webpack_require__(450);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WelcomeMessage2 = __webpack_require__(452);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Search2 = __webpack_require__(454);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Breadcrumb2 = __webpack_require__(456);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Currency2 = __webpack_require__(458);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Language2 = __webpack_require__(460);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SocialIcons2 = __webpack_require__(462);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CustomLink = __webpack_require__(464);
